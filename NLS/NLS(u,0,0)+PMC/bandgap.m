...
targetflag1=1:1:71;
index1=[6,15,21,27,31,34,46,52,58,14,18,24,69,70,71,2,5,50,28,29,53,1,4,10,66,67,68];
targetflag1(index1)=[];
...
for ii = 1:length(ni)
    ...
    if (0<=ni(ii))&&(ni(ii)<=1)
        ...
        lam01=c_const/(2.3e10*ni(ii));%波长
        lam02=c_const/(4.6e10-2.3e10*ni(ii));%波长
        k01=2*pi/lam01;
        k02=2*pi/lam02;
    ...
    save('LD1&2.mat','eigen','Time1','Time2',"nn");
end
