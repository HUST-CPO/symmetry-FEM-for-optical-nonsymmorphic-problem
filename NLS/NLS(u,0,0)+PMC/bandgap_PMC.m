...
targetflag1=1:1:71;
index1=[6,15,21,27,31,34,46,52,58,14,18,24,69,70,71,2,5,50,28,29,53,1,4,10,66,67,68,3,7,17,20,26,33,45,51];
targetflag1(index1)=[];
...
for ii = 1:length(ni)
    ...
    Time2=[Time2,toc];
    nn=[nn,ni(ii)];
    save('LD3&4.mat','eigen','Time1','Time2',"nn");
end
