...
lam01=c_const/4e10;%波长
lam02=c_const/3e10;%波长
...
targetflag1=[1,5,11,15,18,24];
targetflag2=[28,31,51,68,69,73];
...
targetflag1=1:1:79;
% index1=[8,14,16,19,20,34,45,47,56,60,63,66,75,1,5,11,15,18,24,28,31,51,68,69,73,4,7,13,17,21,33,46,59,62,74];
% index1=[8,14,16,19,20,34,45,47,56,60,63,66,75,1,5,11,15,18,24,28,31,51,68,69,73,2,30,57,77,4,7,13,17,21,33,46,59,62,74];
%index1=[8,14,16,19,20,34,45,47,56,60,63,66,75,1,5,11,15,18,24,28,31,51,68,69,73,2,30,57,77];
index1=[8,14,16,19,20,34,45,47,56,60,63,66,75,1,5,11,15,18,24,28,31,51,68,69,73];
targetflag1(index1)=[];
...
for ii = 1:length(ni)
    ...
    if (0<=ni(ii))&&(ni(ii)<=1)
        ...
        DstNodeIndex = copyOfBedge1(:,2);
        SrcNodeIndex = copyOfBedge1(:,1);
        edgephi = edgephi1;
    ...
    % Time2=[Time2,toc];
    % nn=[nn,ni(ii)];
    save('SM3.mat','eigen','Time1','Time2',"nn");
end
