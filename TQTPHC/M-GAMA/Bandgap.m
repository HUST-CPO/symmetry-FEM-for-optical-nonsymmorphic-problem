...
for ii = 1:length(ni)
    ...
    elseif (2<ni(ii))&&(ni(ii)<=3)
        ...
        copyOfBvertex1(end,1)=copyOfBvertex1(1,1);
        nodephi1(end,1)=nodephi1(end,1)*nodephi1(1,1);
        DstNodeIndex = copyOfBvertex1(:,2);
        SrcNodeIndex = copyOfBvertex1(:,1);
        nodephi = nodephi1;
        % [SrcNodeIndex,DstNodeIndex,nodephi]=doubleBloch(SrcNodeIndex,DstNodeIndex,nodephi,Mesh);
    end
...
save('Data3.mat','eigen','Time1','Time2','nn');