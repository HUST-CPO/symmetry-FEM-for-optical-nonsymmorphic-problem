function ff=Assembel2(Mesh,P)
epsilonr=[1,3.5,3.5,1,3.5,3.5];
mur=[1,1,1,1,1,1];
...
for n=1:Mesh.NbrElement
    ...
    for i=1:3
        for j=1:3
            ...
            NumA=NumA+1;
            Ai(NumA)=MappingIndexSi+Mesh.NbrNodes;
            Aj(NumA)=MappingIndexSj+Mesh.NbrNodes;
            Av(NumA)=Sz(i,j);
            ...
            NumB=NumB+1;
            Bi(NumB)=MappingIndexSi+Mesh.NbrNodes;
            Bj(NumB)=MappingIndexSj+Mesh.NbrNodes;
            Bv(NumB)=Tz(i,j);
        end
    end
end
